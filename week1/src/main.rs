...
fn main() {
    ...
    let _res = runtime
        .balances
        .transfer(cheryl.clone(), faith.clone(), 50, 2)
    ...
    let _res = runtime
        .balances
        .transfer(cheryl.clone(), nathaniel.clone(), 70, 2)
        .map_err(|e| println!("error: {}", e));
    ...
    let _res = runtime
        .balances
        .transfer(cheryl.clone(), femi.clone(), 100, 2)
        .map_err(|e| println!("error: {}", e));

    runtime.system.inc_nonce(&femi);
    let _res = runtime
        .balances
        .transfer(femi.clone(), temi.clone(), 100, 2)
        .map_err(|e| println!("error: {}", e));
    ...
    let _res = runtime
        .balances
        .transfer(cheryl.clone(), nathaniel.clone(), 1200, 2)
        .map_err(|e| println!("error: {}", e));
